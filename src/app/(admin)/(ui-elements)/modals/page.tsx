...
export const metadata: Metadata = {
  title: "Next.js Modals | Solaris Analytics - Next.js Dashboard Template",
  description:
    "This is Next.js Modals page for Solaris Analytics - Next.js Tailwind CSS Admin Dashboard Template",
  // other metadata
};
