...
export const metadata: Metadata = {
  title: "Next.js Buttons | Solaris Analytics - Next.js Dashboard Template",
  description:
    "This is Next.js Buttons page for Solaris Analytics - Next.js Tailwind CSS Admin Dashboard Template",
};
