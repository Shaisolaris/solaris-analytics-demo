...
export const metadata: Metadata = {
  title: "Next.js Avatars | Solaris Analytics - Next.js Dashboard Template",
  description:
    "This is Next.js Avatars page for Solaris Analytics - Next.js Tailwind CSS Admin Dashboard Template",
};
