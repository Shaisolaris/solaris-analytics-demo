...
export const metadata: Metadata = {
  title: "Next.js Badge | Solaris Analytics - Next.js Dashboard Template",
  description:
    "This is Next.js Badge page for Solaris Analytics - Next.js Tailwind CSS Admin Dashboard Template",
  // other metadata
};
